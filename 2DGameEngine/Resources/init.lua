...
debugBox:AddComponent("Script"):ToScript():Init("Resources/debugBox.lua")
...
ball2:AddComponent("Sprite"):ToSprite():SetTexture("Resources/blueBall.png")
...
ball3:AddComponent("Sprite"):ToSprite():SetTexture("Resources/blueBall.png")
